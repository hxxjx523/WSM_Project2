const dialogues = [
    { name: "", text: "정말 최재율의 집에 왔다", background: "images/교실 배경.png"},
    { name: "최재율", text: "편하게 앉아~", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "잠깐만 기다려 비디오테이프 가져올게", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "응!", img: "images/김여주 표정5.png", background: "images/교실 배경.png"},
    { name: "", text: "최재율은 집은 엄청 넓었다 그리고 방에 dvd 플레이어가 있었다", background: "images/교실 배경.png"},
    { name: "", text: "올 때까지 시작이 조금 남은 것 같은데 뭘 하고 있을까?", background: "images/교실 배경.png"},
];

const select1_dialogues = [
    { name: "", text: "덜컥", background: "images/교실 배경.png"},
    { name: "최재율", text: "힘들게 찾았어!", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "빨리 보자", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "", text: "최재율은 테이프를 넣었다", background: "images/교실 배경.png"},
    { name: "최재율", text: "오, 시작한다~", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "재밌겠다..!!", img: "images/김여주 표정5.png", background: "images/교실 배경.png"},
    { name: "", text: "그렇게 영상이 시작됐다", background: "images/교실 배경.png"},
    { name: "주인공", text: "복수를 위해 살겠습니다!", background: "images/교실 배경.png"},
    { name: "주인공의 부하", text: "복수합시다! 그들에게!", background: "images/교실 배경.png"},
    { name: "", text: "드라마는 계속됐고 최재율도 제법 집중하면서 보고 있었다", background: "images/교실 배경.png"},
    { name: "", text: "얼굴이 더 선명해져 픽셀의 모습에서 벗어났다!", background: "images/교실 배경.png"},
    { name: "김여주", text: "허업", img: "images/김여주 표정5.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "음.. 그만 쳐다보지? 부끄러운데~", img: "images/최재율 전신.png", background: "images/교실 배경.png"},
