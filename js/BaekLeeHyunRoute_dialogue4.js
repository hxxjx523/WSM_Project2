...
const dialogues = [
    ...
    { name: "김여주", text: "네..", img: "images/김여주 표정4.png", background: "images/교실 배경.png" },
    ...
    { name: "김여주", text: "..? 선배, 전교회장이셨어요?", img: "images/김여주 표정4.png", background: "images/교실 배경.png" },
    { name: "백이현", text: "하하.. 네에~", img: "images/백이현 ver.2.png", background: "images/교실 배경.png" },
    { name: "김여주", text: "아.. 그렇구나", img: "images/김여주 표정4.png", background: "images/교실 배경.png" },
    ...
    { name: "김여주", text: "..?!", img: "images/김여주 표정5.png", background: "images/교실 배경.png" },
...
const select1_dialogues = [
    ...
    { name: "백이현", text: "...", img: "images/백이현 표정5.png", background: "images/교실 배경.png" },
    { name: "김여주", text: "...", img: "images/김여주 표정12.png", background: "images/교실 배경.png" },
    { name: "", text: "이 일이 있고 시간이 지난 후,", img: "", background: "images/교실 배경.png" },
    { name: "김여주", text: "...이현 선배~~~!", img: "images/김여주 표정7png", background: "images/교실 배경.png" },
    { name: "백이현", text: "여주 왔어?", img: "images/백이현 표정3.png", background: "images/교실 배경.png" },
    { name: "백이현", text: "어제 영화 재밌었지?", img: "images/백이현 표정4.png", background: "images/교실 배경.png" },
    { name: "김여주", text: "진짜 완전요", img: "images/김여주 표정7.png", background: "images/교실 배경.png" },
...
const select2_dialogues = [
    ...
    { name: "김여주", text: "넵, 수고하십쇼", img: "images/김여주 표정2.png", background: "images/교실 배경.png" },
...
function yeojooChoice(index) {
    ...
    function ToEnding() {
        window.location.href = "GoodStudentCouncilEnding.html";
    }
