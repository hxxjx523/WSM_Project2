const dialogues = [
    ...
    { name: "김여주", text: "...안녕!", img: "images/김여주 표정4.png", background: "images/등굣길 배경.png"},
    { name: "최재율", text: "오늘도 만났네", img: "images/최재율 ver.2.png", background: "images/등굣길 배경.png"},
    { name: "김여주", text: "응, 운명인가봐~", img: "images/김여주 표정4.png", background: "images/등굣길 배경.png"},
    ...
    { name: "김여주", text: "일단 교실로 갈까?", img: "images/김여주 전신.png", background: "images/등굣길 배경.png"},
    ...
    { name: "김여주", text: "오, 진짜? 나도 볼까 했었는데", img: "images/김여주 전신.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "꼭 봐, 진짜 재밌음~", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "알겠어~ 넌 드라마 자주 봐?", img: "images/김여주 전신.png", background: "images/교실 배경.png"},
    ...
    { name: "김여주", text: "난 드라마 진짜 좋아하는데", img: "images/김여주 표정7.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "맨날 보거든~", img: "images/김여주 표정7.png", background: "images/교실 배경.png"},
    ...
    { name: "김여주", text: "‘리벤지 투 자바’!", img: "images/김여주 표정8.png", background: "images/교실 배경.png"},
    ...
    { name: "김여주", text: "근데 이 작품 판권 문제때문에 몇 화 못봤어...", img: "images/김여주 표정3.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "우리 집에  DVD있는데", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "응? ‘리벤지 투 자바’??!", img: "images/김여주 표정10.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "어어~", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "헐, 나 보러가면 안돼?", img: "images/김여주 표정10.png", background: "images/교실 배경.png"},
    { name: "최재율", text: "와도 돼", img: "images/최재율 ver.2.png", background: "images/교실 배경.png"},
    { name: "김여주", text: "허얼 최고!!!", img: "images/김여주 표정10.png", background: "images/교실 배경.png"},
];
